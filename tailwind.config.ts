  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "verde-musgo-light": "hsl(var(--verde-musgo-light))",
        ...
        "cinza-warm": "hsl(var(--cinza-warm))",
        "cinza-dark": "hsl(var(--cinza-dark))",
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        "card": "0 8px 30px -8px hsl(30 10% 20% / 0.12)",
        "elevated": "0 20px 50px -15px hsl(30 10% 20% / 0.2)",
      },
    },
  },
